function validarForm() {
    ...
    var result_val_checkbox = checkbox();

    
    return (result_val_email && result_val_passw && result_val_direcc && result_val_nombre && result_val_cod_postal
    && result_val_ciudad && result_val_passw2&& result_val_movil && result_val_comuna&&result_val_checkbox);
}
...
function validar_password() {
    ...
    if(passw !=""){
        ...
        div.innerHTML = "La contraseña no puede quedar vacio";
        div.className = "text-danger";
        return false;
    }
}
...
function validar_password2() {
    ...
    if(passw2!=""){
        ...
        div.innerHTML = "La confirmacion no puede quedar vacio";
        div.className = "text-danger";
        return false;
    }
}
...
function checkbox(){
    ...
    if((check1 =="")&&(check2=="")){
        div.innerHTML="Debe seleccionar dos al menos!";
        div.className="text-danger";
        return true;
